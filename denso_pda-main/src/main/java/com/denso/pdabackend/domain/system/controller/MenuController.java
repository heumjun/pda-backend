...
//    }
    ...
    public ResponseEntity<?> getMenuList(@PathVariable String dept) throws Exception {
        ...
        System.out.println("auth.getUserInfo().getDeptCode() >>>>>>>>>>>>> " + auth.getUserInfo().getDeptCode());
        params.setDept(auth.getUserInfo().getDeptCode());
        System.out.println("params >>>> " + params);
